...
|--------|----------------------------------|----------|-----------|-------|
| ✅     | titpetric/vuego                  | 85.30%   | 1254      | 4044  |
...
| ❌     | titpetric/vuego/markdown         | 37.18%   | 56        | 466   |
...
| ✅     | titpetric/vuego/markdown         | Document.FrontMatter              | 50.00%   | 0         |
| ✅     | titpetric/vuego/markdown         | Document.Render                   | 50.00%   | 0         |
| ✅     | titpetric/vuego/markdown         | Document.RenderContext            | 50.00%   | 0         |
| ✅     | titpetric/vuego/markdown         | Markdown.Load                     | 50.00%   | 1         |
| ✅     | titpetric/vuego/markdown         | Markdown.PostProcess              | 50.00%   | 0         |
...
| ✅     | titpetric/vuego/markdown         | Markdown.collectCells             | 50.00%   | 3         |
| ✅     | titpetric/vuego/markdown         | Markdown.inlineContent            | 50.00%   | 0         |
| ✅     | titpetric/vuego/markdown         | Markdown.renderBlockquote         | 37.50%   | 1         |
| ✅     | titpetric/vuego/markdown         | Markdown.renderChildren           | 42.90%   | 3         |
| ❌     | titpetric/vuego/markdown         | Markdown.renderCodeBlock          | 0.00%    | 1         |
| ✅     | titpetric/vuego/markdown         | Markdown.renderFencedCodeBlock    | 33.30%   | 1         |
| ❌     | titpetric/vuego/markdown         | Markdown.renderHTMLBlock          | 0.00%    | 3         |
| ✅     | titpetric/vuego/markdown         | Markdown.renderHeading            | 33.30%   | 1         |
| ✅     | titpetric/vuego/markdown         | Markdown.renderInlineChildren     | 42.90%   | 3         |
| ❌     | titpetric/vuego/markdown         | Markdown.renderInlineNode         | 23.20%   | 10        |
| ✅     | titpetric/vuego/markdown         | Markdown.renderList               | 37.50%   | 1         |
| ✅     | titpetric/vuego/markdown         | Markdown.renderListItem           | 37.50%   | 1         |
| ✅     | titpetric/vuego/markdown         | Markdown.renderNode               | 32.30%   | 3         |
| ✅     | titpetric/vuego/markdown         | Markdown.renderParagraph          | 30.00%   | 1         |
| ✅     | titpetric/vuego/markdown         | Markdown.renderTable              | 50.00%   | 3         |
| ✅     | titpetric/vuego/markdown         | Markdown.renderTemplate           | 44.40%   | 2         |
| ✅     | titpetric/vuego/markdown         | Markdown.tryHandlers              | 28.60%   | 3         |
| ✅     | titpetric/vuego/markdown         | New                               | 50.00%   | 2         |
| ✅     | titpetric/vuego/markdown         | Templates                         | 100.00%  | 0         |
| ✅     | titpetric/vuego/markdown         | alignString                       | 22.20%   | 1         |
| ✅     | titpetric/vuego/markdown         | codeBlockContent                  | 50.00%   | 1         |
| ✅     | titpetric/vuego/markdown         | codeSpanContent                   | 50.00%   | 3         |
| ✅     | titpetric/vuego/markdown         | headingID                         | 50.00%   | 0         |
| ✅     | titpetric/vuego/markdown         | inlineText                        | 35.70%   | 5         |
| ✅     | titpetric/vuego/markdown         | splitFrontMatter                  | 45.50%   | 3         |
